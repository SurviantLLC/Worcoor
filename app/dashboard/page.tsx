  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">Welcome to your Workforce & Inventory Management System</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">7,200</div>
            <div className="flex items-center pt-1">
              <TrendingUp className="mr-1 h-3 w-3 text-green-600" />
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">94.5%</div>
            <div className="flex items-center pt-1">
              <TrendingUp className="mr-1 h-3 w-3 text-green-600" />
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">32.4%</div>
            <div className="flex items-center pt-1">
              <TrendingDown className="mr-1 h-3 w-3 text-amber-600" />
