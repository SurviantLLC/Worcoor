              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={inventoryValueData}>
                    ...
                    <Legend />
                    <Line type="monotone" dataKey="value" stroke={BLUE} activeDot={{ r: 8, fill: AMBER }} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
                  ...
                  <PieChart>
                    ...
                    >
                      {categoryData.map((entry, index) => (
                        <Cell key={`cell-${index}`} fill={index === 0 ? BLUE : index === 1 ? AMBER : "#64748b"} />
                      ))}
                    </Pie>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={stockStatusData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="current" fill={BLUE} name="Current Stock" />
                  <Bar dataKey="minimum" fill={AMBER} name="Minimum Required" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
                  ...
                  <BarChart data={agingData}>
                    ...
                    <Bar dataKey="value" fill={BLUE}>
                      {agingData.map((entry, index) => (
                        <Cell
                          key={`cell-${index}`}
                          fill={index === 0 ? BLUE : index === 1 ? "#4a5568" : index === 2 ? AMBER : "#dc2626"}
                        />
                      ))}
                    </Bar>
                  </BarChart>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={turnoverData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="turnover" fill={BLUE} name="Our Turnover" />
                  <Bar dataKey="industry" fill={AMBER} name="Industry Average" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <RadarChart cx="50%" cy="50%" outerRadius="80%" data={turnoverData}>
                    ...
                    <Radar name="Our Turnover" dataKey="turnover" stroke={BLUE} fill={BLUE} fillOpacity={0.6} />
                    <Radar name="Industry Average" dataKey="industry" stroke={AMBER} fill={AMBER} fillOpacity={0.6} />
                    <Legend />
                    <Tooltip />
                  </RadarChart>
                </ResponsiveContainer>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  ...
                  >
                    ...
                    <Bar dataKey="days" fill={BLUE}>
                      {turnoverData.map((entry, index) => (
                        <Cell key={`cell-${index}`} fill={index % 2 === 0 ? BLUE : AMBER} />
                      ))}
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  ...
                  >
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar yAxisId="left" dataKey="cost" fill={BLUE} name="Wastage Cost ($)" />
                    <Line
                      yAxisId="right"
                      type="monotone"
                      dataKey="percentage"
