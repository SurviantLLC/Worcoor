...
import { BarChartIcon, Calendar, Clock, Package } from "lucide-react"
import {
  Bar,
  BarChart,
  CartesianGrid,
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Task Manager Dashboards</h1>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="manufacturing">Manufacturing Progress</TabsTrigger>
          <TabsTrigger value="workers">Worker Productivity</TabsTrigger>
          <TabsTrigger value="inventory">Inventory & Wastage</TabsTrigger>
        </TabsList>
              ...
              <CardContent>
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={manufacturingProgressData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={workerProductivityData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                      <YAxis />
                      <Tooltip />
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track the progress of production orders</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">PO-2023-001 • Due: Nov 10, 2023</p>
                    </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">PO-2023-002 • Due: Nov 15, 2023</p>
                    </div>
                    <Badge className="bg-blue-100 text-blue-800">In Progress</Badge>
                  </div>
                  <Progress value={45} className="h-2" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">PO-2023-003 • Due: Nov 20, 2023</p>
                    </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">PO-2023-004 • Due: Nov 25, 2023</p>
                    </div>
                    <Badge className="bg-yellow-100 text-yellow-800">Materials Prep</Badge>
                  </div>
                  <Progress value={10} className="h-2" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">PO-2023-005 • Due: Nov 30, 2023</p>
                    </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[400px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={orderTimelineData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="chairs" fill="#8884d8" name="Office Chairs" />
                    <Bar dataKey="tables" fill="#82ca9d" name="Conference Tables" />
                    <Bar dataKey="shelves" fill="#ffc658" name="Bookshelves" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={manufacturingEfficiencyData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                      <YAxis />
                      <Tooltip />
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={bottlenecksData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                      <YAxis />
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="assembly" stroke="#8884d8" name="Assembly" strokeWidth={2} />
                      <Line type="monotone" dataKey="finishing" stroke="#82ca9d" name="Finishing" strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
        ...
        <TabsContent value="workers" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-[400px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={workerDetailedData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">SKU: ADJ-MECH-01</p>
                    </div>
                    <Badge className="bg-orange-100 text-orange-800">Reorder Soon</Badge>
                  </div>
                  <Progress value={40} className="h-2" />
