...
// Update the Table component to have clean borders
...
// Update the TableHeader to use dark blue
const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("[&_tr]:border-b bg-primary text-primary-foreground", className)} {...props} />
  ),
)
...
// Update the TableRow to have alternating colors
...
// Update the TableHead to use dark blue
